...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>D</b>Ü</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Düzce</b>Üni</span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="{{route('blog.index')}}"><i class="fa fa-paper-plane"></i> <span>Announcements</span></a></li>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2021 <a href="#">ET YAZILIM</a>.</strong>Her hakkı saklıdır.
